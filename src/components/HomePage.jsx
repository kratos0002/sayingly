      ...
      <div className="absolute top-0 right-0 p-6">
        {user ? (
          ...
          <button
            ...
            className="group relative inline-flex items-center gap-2 px-5 py-2.5 bg-white/80 backdrop-blur-sm text-blue-600 font-medium rounded-full hover:bg-blue-50 shadow-sm border border-gray-100 transition-all duration-200"
          >
